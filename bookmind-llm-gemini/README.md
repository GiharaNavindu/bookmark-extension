...
3. Paste your **Gemini API key** (get one at [aistudio.google.com](https://aistudio.google.com/app/apikey))
...
| Setting                | Description                                               |
| ---------------------- | --------------------------------------------------------- |
| **API Key**            | Your Gemini API key (stored locally in browser storage)   |
...
- All AI calls go to `generativelanguage.googleapis.com`
- Provider is fixed to Gemini in this variant
